...
SECRET_KEY = 'django-insecure-!vxyq0q2*pj$85o&7#&v1ckq82k8^6x9&yhxo@1q_ze$yc5yc+'
...
# For Development (prints to terminal)
...
# EMAIL_HOST_PASSWORD = 'your-app-password' # Use a [Google App Password](https://myaccount.google.com)
